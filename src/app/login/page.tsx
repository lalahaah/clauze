          ...
          <div style={{ background: R.bgWhite, borderRadius: R.cardRadius, padding: "36px" }}>
            ...
            <button
              ...
              style={{
                ...
                marginBottom: 24, transition: "all 0.15s", opacity: isLoggingIn || loading ? 0.6 : 1,
              }}
            >
            ...
            {error && (
              <div style={{ background: "rgba(217,79,61,0.1)", border: `1px solid ${R.danger}`, borderRadius: R.btnRadius, padding: "12px 16px", marginBottom: 24 }}>
                <p style={{ fontSize: 13, color: R.danger, margin: 0, fontFamily: R.fontSans }}>{error}</p>
              </div>
            )}

            <p style={{ fontSize: 13, textAlign: "center", color: R.textLight, margin: 0, fontFamily: R.fontSans }}>
              Google 계정으로 빠르게 시작하세요.
            </p>
          </div>

          <p style={{ fontSize: 11, color: R.textLight, textAlign: "center", marginTop: 16, lineHeight: 1.6, fontFamily: R.fontSans }}>
